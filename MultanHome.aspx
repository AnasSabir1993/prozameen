<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MultanHome.aspx.cs" Inherits="MultanHome" %>
          ...
          $('#<%= txtArea.ClientID %>').autocomplete({
              source: function (request, response) {
                  $.ajax({
                      ...
                      url: "AutoService.asmx/GetMulAreaNames",
...
<body id="page1">
  ...
  <div class="main">
    <section id="content">
      <div class="wrapper">
        <article class="col1">
          <div  id="slider" style="background-image: url('http://localhost:57519/images/Multan.jpg')"></div>
        </article>
        <article class="col2">
