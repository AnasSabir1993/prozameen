<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KarachiHome.aspx.cs" Inherits="KarachiHome" %>
          ...
          $('#<%= txtArea.ClientID %>').autocomplete({
              source: function (request, response) {
                  $.ajax({
                      ...
                      url: "AutoService.asmx/GetKhiAreaNames",
...
<body id="page1">
  ...
  <div class="main">
    <section id="content">
      <div class="wrapper">
        <article class="col1">
          <div  id="slider" style="background-image: url('http://localhost:57519/images/karachi.png')"></div>
        </article>
        <article class="col2">
