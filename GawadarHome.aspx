<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GawadarHome.aspx.cs" Inherits="GawadarHome" %>
...
<body id="page1">
  ...
  <div class="main">
    <section id="content">
      <div class="wrapper">
        <article class="col1">
          <div  id="slider" style="background-image: url('http://localhost:57519/images/page4_img1.jpg')"></div>
        </article>
        <article class="col2">
