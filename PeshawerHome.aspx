<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PeshawerHome.aspx.cs" Inherits="PeshawerHome" %>
...
<body id="page1">
  ...
  <div class="main">
    <section id="content">
      <div class="wrapper">
        <article class="col1">
          <div  id="slider" style="background-image: url('http://localhost:57519/images/Peshawar.png')"></div>
        </article>
        <article class="col2">
