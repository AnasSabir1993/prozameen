<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LahoreHome.aspx.cs" Inherits="LahoreHome" %>
          ...
          $('#<%= txtArea.ClientID %>').autocomplete({
              source: function (request, response) {
                  $.ajax({
                      ...
                      url: "AutoService.asmx/GetLhrAreaNames",
...
<body id="page1">
  ...
  <div class="main">
    <section id="content">
      <div class="wrapper">
        <article class="col1">
          <div  id="slider" style="background-image: url('http://localhost:57519/images/lahore.png')"></div>
        </article>
        <article class="col2">
