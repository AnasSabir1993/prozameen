<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GhotkiHome.aspx.cs" Inherits="GhotkiHome" %>
...
<body id="page1">
  ...
  <div class="main">
    <section id="content">
      <div class="wrapper">
        <article class="col1">
          <div  id="slider" style="background-image: url('http://localhost:57519/images/page2_img2.jpg')"></div>
        </article>
        <article class="col2">
