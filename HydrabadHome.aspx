<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HydrabadHome.aspx.cs" Inherits="HydrabadHome" %>
...
<body id="page1">
  ...
  <div class="main">
    <section id="content">
      <div class="wrapper">
        <article class="col1">
          <div  id="slider" style="background-image: url('http://localhost:57519/images/page5_img1.jpg')"></div>
        </article>
        <article class="col2">
